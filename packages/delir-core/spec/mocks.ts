...
export const mockProject = (props: Partial<Project> = {}) =>
    safeAssign(new Project({}), props)
...
export const mockLayer = (props: Partial<Layer> = {}) =>
    safeAssign(new Layer({ name: 'mocked-layer' }), props)
