...
export default class DelirValueInput extends React.PureComponent<DelirValueInputProps, any>
{
    ...
    public render()
    {
        ...
        switch (descriptor.type) {
                ...
                component = (
                    <>
                        ...
                        <Dropdown ref={this.ref.colorPickerDropdown} className={s.colorPickerContainer}>
                            ...
                            <ChromePicker ref={this.ref.colorPicker} color={value.toString()} onChange={this.valueChanged} disableAlpha={descriptor.type === 'COLOR_RGB'} />
                        </Dropdown>
                    </>
                )
                break
            ...
            case 'BOOL':
                component = <input ref={this.ref.checkbox} type='checkbox' className={s.checkbox} checked={value as boolean} onChange={this.valueChanged} />
                break
                ...
                component = (
                    <>
                        <Dropdown ref={this.ref.textInputDropdown}>
                            <textarea ref={this.ref.textArea} className={s.textArea} onKeyDown={this.onKeydownTextArea} defaultValue={value as string} />
                        </Dropdown>
                        <input ref={this.ref.textSummary} type='text' className={s.textInput} onFocus={this.onFocusTextInput} value={value as string} readOnly />
                    </>
                )
                break
            ...
            case 'FLOAT':
            case 'NUMBER':
                component = <DragNumberInput ref={this.ref.numberInput} value={value as number} onChange={this.valueChanged} allowFloat={descriptor.type === 'FLOAT'} />
                break
            ...
            case 'ASSET': {
                ...
                component = (
                    <>
                        <select ref={this.ref.assetSelect} value={value ? (value as {assetId: string}).assetId! : undefined} onChange={this.valueChanged}>
