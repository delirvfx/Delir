...
export const ProjectModActions = {
    ...
    addKeyframeAction: action<{ targetClip: Delir.Project.Clip, paramName: string, keyframe: Delir.Project.Keyframe }>(),
    addEffectIntoClipAction: action<{ clipId: string, effect: Delir.Project.Effect }>(),
    addEffectKeyframeAction: action<{ targetClipId: string, targetEffectId: string, paramName: string, keyframe: Delir.Project.Keyframe }>(),
