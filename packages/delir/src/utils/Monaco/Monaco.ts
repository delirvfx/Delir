...
const typeDefinitionLibs = {
  ...
  'lib.es2016.array.include.d.ts': require('!raw-loader!typescript/lib/lib.es2016.array.include.d.ts').default,
  'console.d.ts': require('!raw-loader!./console.d.ts.txt').default,
}
